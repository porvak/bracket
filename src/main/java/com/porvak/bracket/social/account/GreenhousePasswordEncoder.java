 ...
 */
package com.porvak.bracket.social.account;
...
import static org.springframework.security.crypto.util.EncodingUtils.*;
 ...
 * See {@link org.springframework.security.crypto.password.StandardPasswordEncoder} for an implementation that does perform digest iteration correctly (which makes its digests more secure).
 * @author Keith Donald
