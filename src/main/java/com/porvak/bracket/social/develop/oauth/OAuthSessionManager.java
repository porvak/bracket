...
public interface OAuthSessionManager {
	...
	/**
	 * For the OAuthSession identified by the requestToken, grant the application identified by the {@link com.porvak.bracket.social.develop.oauth.OAuthSession#getApiKey()} access to the
	 * {@link com.porvak.bracket.social.develop.oauth.OAuthSession#getAuthorizingAccountId() authorizing member account}.
