...
public abstract class JoinRowMapper<R, I>  {
	...
	/**
	 * Return a {@link org.springframework.jdbc.core.RowMapper} that maps exactly one root object R, where there may be multiple R rows for each child in a join with a one-to-many relationship.
	 */
	...
	/**
	 * Return a {@link org.springframework.jdbc.core.ResultSetExtractor} that 1..n root objects R into a List where there may be multiple R rows for each joined child.
	 */
