 ...
 * We use {@link org.springframework.jdbc.core.JdbcTemplate} to access that data.
 * We use compile-time-woven AspectJ-advice around {@link org.springframework.transaction.annotation.Transactional} methods to apply transaction management.
